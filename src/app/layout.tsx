...
export const metadata: Metadata = {
  ...
  description: "Discover curated luxury fashion, timepieces, and accessories at VALIDÉ. Experience premium shopping with worldwide shipping.",
  keywords: "luxury fashion, designer watches, premium accessories, luxury shopping, VALIDÉ",
  authors: [{ name: "VALIDÉ" }],
