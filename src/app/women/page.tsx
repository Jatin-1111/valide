        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="font-lato max-w-2xl mx-auto px-4">
              Discover a world of feminine elegance through our exquisite
              collection of designer pieces. From statement jewelry to timeless
              accessories, each piece tells a story of sophistication and grace.
            </p>
          </div>
        </div>
      </div>
