  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await fetch(
        "https://validebackend.onrender.com/api/products/category/mens"
      );
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="font-lato max-w-2xl mx-auto px-4">
              Explore our prestigious collection of men&apos;s essentials, from
              refined clothing and leather goods to exquisite timepieces and
              jewelry. Where timeless style meets contemporary luxury.
            </p>
          </div>
        </div>
      </div>
